...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");


 // Слайдер-карусель на основе статической верстки

_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.carousel = function (autoplay, autoplayInterval = 5000) {
  for (let i = 0; i < this.length; i++) {
    ...
    widthDigits = +width.replace(/\D/g, ''),
          ...
          dots = this[i].querySelectorAll('.carousel-indicators li'); // ширина обертки равна общей ширине всех слайдов

    slidesField.style.width = 100 * slides.length + '%'; // устанавливаем ширину всех слайдов равной ширине самого слайдера

    slides.forEach(slide => {
      slide.style.width = width;
    });
    let offset = 0;
    let slideIndex = 0; // класс активности для первой точки
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i].querySelector('[data-slide="next"]')).click(e => {
      e.preventDefault();
      nextSlide();
    }); // обработка клика назад

    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i].querySelector('[data-slide="prev"]')).click(e => {
      e.preventDefault();
    ...
    const sliderId = Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).getAttr('id');
    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(`#${sliderId} .carousel-indicators li`).click(e => {
...
Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])('.carousel').carousel(true, 2000); // Динамическое создание слайдера-карусели

_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.createSlider = function ({
  slides,
  settings
} = {}) {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).addClass('carousel'); // создаем массив слайдов и точек (количество слайдов, пути к ним и альты задаются в настройках)
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).html(`
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).find('.carousel-slides')[0].append(...slds); // Добавляем дотсы (в зависимости от количества слайдов)

    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).find('.carousel-indicators')[0].append(...dots); // применяем механизм слайдера для статической верстки на только что созданную динамически структуру

    Object(_core__WEBPACK_IMPORTED_MODULE_2__["default"])(this[i]).carousel(settings.autoplay, settings.autoplayInterval);
  }
};
...
Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-toggle="modal"]').modal(); // Создание динамического модального окна
...
$.prototype.init = function (selector) {
  ...
  Object.assign(this, document.querySelectorAll(selector)); // добавляем метод length
...
$.prototype.init.prototype = $.prototype; // Записываем эту функцию в глобальный объект window

window.$ = $; // Создаваемая библиотека пригодится в других файлах, поэтому экспортируем ее. Если бы этого не было, то и экспортировать не надо было бы, т.к. она уже в глобальном объекте window
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.dynamicCarousel').createSlider({
  slides: {
    count: 5,
    settings: [["https://krot.info/uploads/posts/2020-01/1579388380_1-2.jpg", "photo1"], ["https://img.golos.io/proxy/https://hermestravel.lv/wp-content/uploads/2016/05/phuket-min.jpg", "photo2"], ["https://img3.akspic.ru/image/72818-liniya_gorizonta-otrazhenie-stolica-gorodskoj_rajon-vankuver-1920x1080.jpg", "photo3"], ["https://cdn.pixabay.com/photo/2020/01/17/13/18/sheep-4772994_960_720.jpg", "sheep"], ["https://cdn.pixabay.com/photo/2020/07/11/08/00/deer-5393082_960_720.jpg", "moose"], ["https://cdn.pixabay.com/photo/2020/07/09/09/05/cat-5386372_960_720.jpg", "kitten"]]
  },
  settings: {
    autoplay: false,
